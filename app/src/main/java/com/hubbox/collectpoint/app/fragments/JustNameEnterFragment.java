 ...
 * {@link OnJustNameEnterFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class JustNameEnterFragment extends Fragment implements ITagFragment {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnJustNameEnterFragmentInteractionListener) {
            mListener = (OnJustNameEnterFragmentInteractionListener) context;
        } else {
